                    ...
                    @else
                        <form wire:submit.prevent="confirmAcceptance">
                            ...
                            <div class="flex gap-3 pt-6 border-t border-border">
                                ...
                                <button type="submit"
                                        class="flex-1 inline-flex justify-center items-center px-4 py-2 bg-primary text-primary-foreground rounded-lg font-medium hover:bg-primary/90 transition-colors">
