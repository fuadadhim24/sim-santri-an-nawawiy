...
return new class extends Migration {
    ...
    {
        if (config('database.default') === 'mysql') {
            DB::statement("ALTER TABLE students MODIFY COLUMN special_status ENUM('UMUM', 'ANAK_GURU', 'YATIM') NOT NULL DEFAULT 'UMUM'");
            DB::statement("ALTER TABLE discounts MODIFY COLUMN target_status ENUM('ANAK_GURU', 'YATIM') NOT NULL");
        }
    }
};
